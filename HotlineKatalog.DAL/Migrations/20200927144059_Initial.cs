        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceTag = table.Column<string>(nullable: true),
                    SpecificationTag = table.Column<string>(nullable: true),
                    NextPageTag = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopTags_Shops_Id",
                        column: x => x.Id,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopGoods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopGoods_Goods_GoodId",
                        column: x => x.GoodId,
                        principalTable: "Goods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShopGoods_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specifications_Goods_Id",
                        column: x => x.Id,
                        principalTable: "Goods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopGoods_GoodId",
                table: "ShopGoods",
                column: "GoodId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopGoods_ShopId",
                table: "ShopGoods",
                column: "ShopId");
        }
